...
namespace NGANHANG_PHANTAN_NHOM29 {
    ...
    public partial class DS : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationfrmMoTaiKhoanKH_InfoCustomer_TaiKhoan;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationfrmMoTaiKhoanKH_InfoCustomer_TaiKhoan = this.Relations["frmMoTaiKhoanKH_InfoCustomer_TaiKhoan"];
        ...
        private void InitClass() {
            ...
            this.relationfrmMoTaiKhoanKH_InfoCustomer_TaiKhoan = new global::System.Data.DataRelation("frmMoTaiKhoanKH_InfoCustomer_TaiKhoan", new global::System.Data.DataColumn[] {
                        this.tablefrmMoTaiKhoanKH_InfoCustomer.CMNDColumn}, new global::System.Data.DataColumn[] {
                        this.tableTaiKhoan.CMNDColumn}, false);
            this.Relations.Add(this.relationfrmMoTaiKhoanKH_InfoCustomer_TaiKhoan);
            this.relationFK_TaiKhoan_KhachHang1 = new global::System.Data.DataRelation("FK_TaiKhoan_KhachHang1", new global::System.Data.DataColumn[] {
                        this.tableThongTinKH_TKSaoKe.CMNDColumn}, new global::System.Data.DataColumn[] {
                        this.tableTaiKhoan.CMNDColumn}, false);
        ...
        public partial class TaiKhoanRow : global::System.Data.DataRow {
            ...
            public frmMoTaiKhoanKH_InfoCustomerRow frmMoTaiKhoanKH_InfoCustomerRow {
                get {
                    return ((frmMoTaiKhoanKH_InfoCustomerRow)(this.GetParentRow(this.Table.ParentRelations["frmMoTaiKhoanKH_InfoCustomer_TaiKhoan"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["frmMoTaiKhoanKH_InfoCustomer_TaiKhoan"]);
                }
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ThongTinKH_TKSaoKeRow ThongTinKH_TKSaoKeRow {
                get {
                    return ((ThongTinKH_TKSaoKeRow)(this.GetParentRow(this.Table.ParentRelations["FK_TaiKhoan_KhachHang1"])));
                }
                set {
        ...
        public partial class frmMoTaiKhoanKH_InfoCustomerRow : global::System.Data.DataRow {
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TaiKhoanRow[] GetTaiKhoanRows() {
                if ((this.Table.ChildRelations["frmMoTaiKhoanKH_InfoCustomer_TaiKhoan"] == null)) {
                    return new TaiKhoanRow[0];
                }
                else {
                    return ((TaiKhoanRow[])(base.GetChildRows(this.Table.ChildRelations["frmMoTaiKhoanKH_InfoCustomer_TaiKhoan"])));
                }
            }
        }
...
SELECT SOTK, CMND, SODU, MACN, NGAYMOTK FROM TaiKhoan WHERE (SOTK = @SOTK)";
    ...
    public partial class ThongTinKH_TKSaoKeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT KH.HO + \' \' + KH.TEN  AS HOTEN , KH.CMND,TK.SOTK\r\nFROM KhachHang AS KH LEF" +
                "T OUTER JOIN\r\n                  dbo.TaiKhoan AS TK ON KH.CMND = TK.CMND\r\nWHERE  " +
                "(TK.SOTK <> \'NULL\')\r\nORDER BY TEN";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
